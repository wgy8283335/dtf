...
public final class LogUtilForSyncFinalSuccess {
     ...
     */
    private Logger logger = LoggerFactory.getLogger(LogUtilForSyncFinalSuccess.class);
     ...
     */
    public static LogUtilForSyncFinalSuccess getInstance() {
        return LogUtilForSyncFinalSuccess.SingleHolder.INSTANCE;
    }
