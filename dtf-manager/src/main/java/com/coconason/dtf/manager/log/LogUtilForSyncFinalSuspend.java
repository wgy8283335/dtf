...
public final class LogUtilForSyncFinalSuspend {
    
    /**
     * Logger of log utility.
     */
    private Logger logger = LoggerFactory.getLogger(LogUtilForSyncFinalSuspend.class);
    ...
    private static final String LOG_FILE_NAME="sync-final-suspend.log";
    
    private LogUtilForSyncFinalSuspend(final String logFilePath) {
        try {
     ...
     */
    public static LogUtilForSyncFinalSuspend getInstance() {
        return LogUtilForSyncFinalSuspend.SingleHolder.INSTANCE;
    }
